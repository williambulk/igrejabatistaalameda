...
<script src="<?php bloginfo('template_url') ?>/js/dist/jquery.mb.YTPlayer.js"></script>
...
<script type="text/javascript" src="<?php bloginfo('template_url') ?>/js/bootstrap-table.js"></script>
<script type="text/javascript" src="<?php bloginfo('template_url') ?>/js/filter-control/bootstrap-table-filter-control.js"></script>
<?php wp_footer(); ?>
</body>
</html>